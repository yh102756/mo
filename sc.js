const title = [{"singer": "거미", "songs": ["그대 돌아오면", "음악이 끝나기 전에", "친구라도 될 걸 그랬어"]},
    ...
    {"singer": "지아", "songs": ["물론", "사랑하지 않아서 그랬니", "술 한잔 해요"]}, {"singer": "청하", "songs": ["그 끝에 그대"]}, {"singer": "초승", "songs": ["짝사랑", "호수"]},
...
const disney = [{"singer": "디즈니", "songs": ["Speechless (알라딘)"]},
    ...
    {"singer": "Dr.Cantabile", "songs": ["I See the Light (라푼젤)"]},
    {"singer": "Idina Menzel", "songs": ["Let It Go(겨울왕국)"]},
    {"singer": "Idina Menzel", "songs": ["Love Is an Open Door (겨울왕국)"]},
